...
class AnalysisDependentHookDefinitions : Hook {
    ...
    private fun integrityRelatedHooks(): Set<HookInfo> {
        ...
        val integrity1 = MethodHookInfo("<zhenhao.forced.fuzzdroid.wrapper.DummyWrapper: android.content.pm.PackageInfo dummyWrapper_getPackageInfo(android.content.pm.PackageManager,java.lang.String,int)>")
    ...
    private fun fileRelatedHooks(): Set<HookInfo> {
        ...
        val propertyString1 = MethodHookInfo("<zhenhao.forced.fuzzdroid.wrapper.DummyWrapper: java.lang.String dummyWrapper_getProperty(java.util.Properties,java.lang.String)>")
        propertyString1.analysisDependentHookAfter()
        val propertyString2 = MethodHookInfo("<zhenhao.forced.fuzzdroid.wrapper.DummyWrapper: java.lang.String dummyWrapper_getProperty(java.util.Properties,java.lang.String,java.lang.String)>")
    ...
    private fun reflectionHooks(): Set<HookInfo> {
        ...
        val getMethodHookAfter = MethodHookInfo("<zhenhao.forced.fuzzdroid.wrapper.DummyWrapper: java.lang.reflect.Method dummyWrapper_getMethod(java.lang.Class,java.lang.String,java.lang.Class[])>")
