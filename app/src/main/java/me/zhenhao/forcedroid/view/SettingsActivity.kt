...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    override fun onBuildHeaders(target: List<android.preference.PreferenceActivity.Header>) {
        loadHeadersFromResource(me.zhenhao.forcedroid.R.xml.pref_headers, target)
    }
    ...
    override fun isValidFragment(fragmentName: String): Boolean {
        return android.preference.PreferenceFragment::class.java.name == fragmentName
                || me.zhenhao.forcedroid.view.SettingsActivity.GeneralPreferenceFragment::class.java.name == fragmentName
                || me.zhenhao.forcedroid.view.SettingsActivity.DataSyncPreferenceFragment::class.java.name == fragmentName
                || me.zhenhao.forcedroid.view.SettingsActivity.NotificationPreferenceFragment::class.java.name == fragmentName
    }
    ...
    class GeneralPreferenceFragment : android.preference.PreferenceFragment() {
        override fun onCreate(savedInstanceState: android.os.Bundle?) {
            super.onCreate(savedInstanceState)
            addPreferencesFromResource(me.zhenhao.forcedroid.R.xml.pref_general)
    ...
    class NotificationPreferenceFragment : android.preference.PreferenceFragment() {
        override fun onCreate(savedInstanceState: android.os.Bundle?) {
            super.onCreate(savedInstanceState)
            addPreferencesFromResource(me.zhenhao.forcedroid.R.xml.pref_notification)
            setHasOptionsMenu(true)
    ...
    class DataSyncPreferenceFragment : android.preference.PreferenceFragment() {
        override fun onCreate(savedInstanceState: android.os.Bundle?) {
            super.onCreate(savedInstanceState)
            addPreferencesFromResource(me.zhenhao.forcedroid.R.xml.pref_data_sync)
            setHasOptionsMenu(true)
        ...
        private val sBindPreferenceSummaryToValueListener = android.preference.Preference.OnPreferenceChangeListener { preference, value ->
            ...
            if (preference is android.preference.ListPreference) {
                ...
                if (android.text.TextUtils.isEmpty(stringValue)) {
                    ...
                    preference.setSummary(me.zhenhao.forcedroid.R.string.pref_ringtone_silent)
